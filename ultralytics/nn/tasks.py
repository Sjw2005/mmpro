...
from ultralytics.nn.AddModules import *  #导入新增模块
import contextlib
import pickle
import re
import types
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in {
            ...
            MF, A2C2f, C3k2_MBConv, A2C2f_MBConv, C2f_MBConv, C2fCIB_MBConv, nn.Conv2d, Blocks, ConvNormLayer, DSConv, DSC3k2, SPDConv,
        }:
            c1, c2 = ch[f], args[0]
        ...
        #     c2 = ch[f[-1]]
            ...
            c2 = args[0]
        elif m is MOESelector:
            c2 = args[0]
        elif m in {DySample}:
            c1 = ch[f]
            c2 = c1  # DySample保持通道数不变
            args = [c1, *args]
        elif m in {LSKA}:
            c2 = ch[f]
            args = [c2, *args]
...
#修改---------------HGBlock
        elif m in {HGStem, HGBlock,Light_HGBlock,HGBlock_APConv}:
...
#Add---  
            ...
            if m in {HGBlock,Light_HGBlock,HGBlock_APConv}:
