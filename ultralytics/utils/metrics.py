...
def bbox_inner_iou(box1, box2, xywh=True, CIoU=True, ratio=0.7, eps=1e-7):
    """Inner-IoU: 在内缩框上计算IoU以增强小目标梯度信号，外框计算距离/宽高比惩罚。
    ...
    ib1_x1 = cx1 - inner_w1 / 2
    ib1_x2 = cx1 + inner_w1 / 2
    ib1_y1 = cy1 - inner_h1 / 2
    ib1_y2 = cy1 + inner_h1 / 2
    ib2_x1 = cx2 - inner_w2 / 2
    ib2_x2 = cx2 + inner_w2 / 2
    ib2_y1 = cy2 - inner_h2 / 2
    ib2_y2 = cy2 + inner_h2 / 2

    # 内缩框交集
    inner_inter = (ib1_x2.minimum(ib2_x2) - ib1_x1.maximum(ib2_x1)).clamp_(0) * (
